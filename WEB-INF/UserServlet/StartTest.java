...
public class StartTest extends HttpServlet
{
	...
	{
	 long User_Id = 0;	
	 int Test_Id = 0,time=0,Timed=0,Test_type=0,Total_Ques=0;
     ...
     out.println("<P><BR><BR>");
     out.println("<TABLE cellSpacing=0 cellPadding=15 width=\"629\" align=\"center\" " +
     ...
     out.println("<CENTER>Start Test Warning</CENTER></FONT></U></STRONG>");
     out.println("</STRONG></FONT></FONT><br>");
     ...
     out.println("<FORM name=\"StartTest\" action=\"/examples/servlet/TestPage\">");
