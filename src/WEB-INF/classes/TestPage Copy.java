...
*/   	
	...
	out.println("<P>&nbsp;</P> " + "<P>" +
				 ...
				 "</FORM>" +
				 "<P>" +
				 "<FORM NAME=\"ReviewAnswers\" ACTION=\"http://localhost:8080/examples/servlets/User/ReviewAnswers.jsp\">" +				 
				 "<INPUT name=\"SubmitTest\" type=\"submit\" value=\" Submit Test  \">" +
				 "</FORM>");
	out.println("</P>");
	...
	if(Timed == 1)
	{
      ...
      out.println("<input type=\"text\" name=\"face\" size=9 value=\"\"> "); 		
	}
	out.println("</body>");
	out.println("</html>");
